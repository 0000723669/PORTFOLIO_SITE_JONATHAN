...
const clickDireito = (event)=>{
    ...
    if (event.button == 2) {
        currentId = event.target.closest("tr").id.split("")[4];
        const confirm = window.confirm(`Voc\xea tem certeza que deseja deletar o usu\xe1rio ${data[currentId].getNome().toUpperCase()}?`);
        if (confirm) {
...
},{"./model/usuario.model.js":"jiRrF","./view/viewController.js":"kwPhY","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"jiRrF":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{}],"kwPhY":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
const formNewUser = {
    build: ()=>{
      ...
      <h3 class="mt-4 text-center">Cadastro de Novo Usu\xe1rio</h3>
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"3hFNO":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
